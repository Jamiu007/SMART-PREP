...
export default function AuthPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f9fc] p-4 text-slate-900">
      <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-6xl overflow-hidden rounded-[2rem] bg-white shadow-2xl shadow-slate-900/10 lg:grid-cols-[1.05fr_.95fr]">
        <section className="hidden bg-[#10243c] p-12 text-white lg:flex lg:flex-col">
          <div className="flex items-center gap-2 font-extrabold">
            <span className="grid h-9 w-9 place-items-center rounded-xl bg-emerald-400 text-[#10243c]">
              <GraduationCap />
            </span>
            TutorTrack
          </div>
        ...
        <section className="mx-auto flex w-full max-w-md flex-col justify-center p-7 sm:p-12">
